...
\begin{enumerate}
    ...
    \item Comparar el rendimiento de las redes neuronales y SVM al resolver el problema HCSP, usando el \textit{makespan} como medida de la calidad de los resultados.    
