...
\paragraph{} Inspirado en Dorronsoro et al.
(2013), se optó por trabajar con clasificadores entrenados con una determinada dimensión del problema (en particular $512$ tareas sobre $16$ máquinas o $512\times 16$) a la hora de clasificar instancias del problema de menor, igual y mayor cantidad de tareas.
...
\paragraph{} Como fue mencionado en el capítulo \textit{Implementación}, para obtener una primera selección de parámetros de configuración para el entrenamiento de las redes neuronales se utilizó \textit{model\_selection.GridSearchCV()} de \textit{scikit-learn}.
