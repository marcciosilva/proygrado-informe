...
La Figura \ref{fig:svm_margin} muestra el funcionamiento de una SVM en un problema de clasificación de dos clases.
...
El hiperplano generado por SVM se muestra como la recta negra y se marcan los márgenes en lineas punteadas.
...
\paragraph{}Entre las desventajas de utilizar SVM encontramos que los tiempos de entrenamiento asociados pueden ser significativos para grandes conjuntos de entrenamiento, pudiendo tener consumos considerables de memoria tanto durante el entrenamiento como en la validación.
