...
% Se carga bibliografía y estilo bibliográfico
  \usepackage[
  	sorting=none,
    bibstyle=chem-biochem,citestyle=numeric,biblabel=brackets,
    natbib=true
  ]{biblatex}
  \DefineBibliographyStrings{spanish}{andothers={et al.}}
% Más estilos bibliográficos https://www.sharelatex.com/learn/Biblatex_bibliography_styles 
\usepackage{csquotes}
